                ...
                else
                {
                    if (password.compareTo(confirm)==0)
                    {
                     if(isValid(password))
                     {
                         ...
                         Toast.makeText(getApplicationContext(), "Password must contain at leat 8 characters,having letter,digit and special character", Toast.LENGTH_SHORT).show();
                     }

                    }
                    else{
                        Toast.makeText(getApplicationContext(), "Password and Confirm didint match", Toast.LENGTH_SHORT).show();
                    }
